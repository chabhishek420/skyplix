<?php
	...
	if (isset($_POST['affiliate']))
	{
		...
		$sql="INSERT INTO affiliates (affiliate_name) VALUES (\"" . $_POST['affiliate'] . "\")";
		if (!mysql_query($sql))
		{
	...
	{	
		...
		$html .= "<form name=\"add_affiliate\" action=\"add_affiliate.php\" method=\"post\">";
		$html .= "Please add name of affiliate: <input type=\"text\" name=\"affiliate\"><br />";
