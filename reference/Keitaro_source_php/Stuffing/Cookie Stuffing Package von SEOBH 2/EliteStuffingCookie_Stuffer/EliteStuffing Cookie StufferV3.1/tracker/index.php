<?php	
	...
	$html .= "<table border=0 width=\"700\"><tr><td>Affiliate Name</td><td>Affiliate URL ID</td><td>Cookies Stuffed</td><td>Banner Impressions</td><td>CTR</td><td>Edit</td><td>Delete</td></tr>";
	...
	{
		$html .=	"<tr><td align=right>" . $row['affiliate_name'] . "</td><td align=right>" . $row['link_id'] . "</td><td align=right>" . $row['cookies'] . "</td><td align=right>" . $row['impressions'] . "</td><td align=right>" . round(($row['cookies']/($row['impressions']+1)),2) . "</td>";
		$html .= 	"<td align=right><a href=\"http://" . $_SERVER['SERVER_NAME'] . "/tracker/edit_affiliate_link.php?id=" . $row['link_id'] . "\">Edit Link</a>";
		$html .= 	"<td align=right><a href=\"http://" . $_SERVER['SERVER_NAME'] . "/tracker/delete_affiliate_link.php?id=" . $row['link_id'] . "\">Delete Link</a></tr>";
	} 
	$html .= "</table>";
	$html .= "</div>";
	$html .= "</body></html>";
